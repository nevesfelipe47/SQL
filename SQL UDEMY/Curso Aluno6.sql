...
--- FORMATAÇÃO DE DATA ---
 ...
 SELECT To_Char (SYSDATE, 'DD/MM/YY HH24:MM:SS') DATA_HORA FROM DUAL;
...
SELECT Trim (To_Char(SALARIO,'L99999.99')) SALARIO1,      -- TRIM ELIMINA ESPAÇOS VAZIOS ---
 Trim (TO_CHAR (SALARIO,'L99G999D99')) SALARIO2
 FROM TALUNO;

SELECT To_Char (SALARIO,'L999999.99')AS SALARIO_1,
 To_Char (SALARIO, 'L99G999D99')AS SALARIO_2
 FROM TALUNO;
 ...
 SELECT LPad (Trim((To_Char(5000, 'L9999.99'))), '12',' ') FROM DUAL;
