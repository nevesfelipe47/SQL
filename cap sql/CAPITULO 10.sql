...
---- capitulo 10 ----
  ...
  --- CASO PRECISE EXCLUIR UMA CONSTRAINT
  --- ALTER TABLE TPESSOA( NOME DA TABLE) DROP CONSTRAINT NOME_CONSTRAINT
   ...
   INSERT INTO TPESSOA VALUES (2,'R','BEATRIZ', 'F', 1,'1234');

   INSERT INTO TPESSOA VALUES (3,'F','PEDRO', 'F', 4, '123');

   INSERT INTO TPESSOA VALUES (4,'X','MARIA', 'J', 5, '123');
